...
export function useMouseCoordinates() {
  ...
  useEffect(() => {
    ...
    */
     function handleMouseCoordinates({clientX,  clientY}) {
      setCoordinates({
        clientX:clientX,
        clientY:clientY
      })
    ...
    */
     window.addEventListener("mousemove", handleMouseCoordinates)
    ...
    return function cleanup() {
      ...
      */
       window.removeEventListener("mousemove", handleMouseCoordinates)
    };
  }, []);
